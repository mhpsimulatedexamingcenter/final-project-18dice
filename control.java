...
public class control implements Initializable {
	...
	void showdice(int s1, int s2, int s3) {
		...
		case 1:
			...
			try {
				image1 = new Image(
						FileSystems.getDefault().getPath("src", "fp", "dice1.jpg").toUri().toURL().toString());
		...
		case 2:
			...
			try {
				image2 = new Image(
						FileSystems.getDefault().getPath("src", "fp", "dice2.jpeg").toUri().toURL().toString());
		...
		case 3:
			...
			try {
				image3 = new Image(
						FileSystems.getDefault().getPath("src", "fp", "dice3.jpeg").toUri().toURL().toString());
		...
		case 4:
			...
			try {
				image4 = new Image(
						FileSystems.getDefault().getPath("src", "fp", "dice4.jpeg").toUri().toURL().toString());
		...
		case 5:
			...
			try {
				image5 = new Image(
						FileSystems.getDefault().getPath("src", "fp", "dice5.jpeg").toUri().toURL().toString());
		...
		case 6:
			...
			try {
				image6 = new Image(
						FileSystems.getDefault().getPath("src", "fp", "dice6.jpeg").toUri().toURL().toString());
